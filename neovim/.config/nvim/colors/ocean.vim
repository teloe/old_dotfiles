...
if !has("gui_running")
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/ocean.sh"
  endif
endif
...
" C# highlighting
call <sid>hi("csClass",                 s:gui06, "", s:cterm06, "", "", "")
call <sid>hi("csAttribute",             s:gui06, "", s:cterm06, "", "", "")
...
call <sid>hi("jsThis",              s:gui06, "", s:cterm06, "", "", "")
...
call <sid>hi("SignifySignDelete",  s:gui06, s:gui01, s:cterm06, s:cterm01, "", "")
