" Vim color file
" 
" This is a mirror of rdark, https://github.com/vim-scripts/rdark
" Replaced green and orange with some colors from blackdust, https://github.com/vim-scripts/blackdust.vim
" Work in progress
...
" Search
hi Search guifg=#2e3436 guibg=#eee8aa
hi IncSearch guibg=#2e3436 guifg=#eee8aa
...
hi Question guifg=#cc9393 gui=none
...
" Specials
hi Title guifg=#8fffff
hi Todo guifg=#8fffff guibg=bg
...
" Matches
" hi MatchParen guifg=#2e3436 guibg=#8fffff
...
hi Constant guifg=#cc9393
hi Number guifg=#cc9393
hi Statement guifg=#729fcf gui=none
hi Identifier guifg=#ffffff
hi PreProc guifg=#8fffff
hi Function guifg=#8fffff
...
hi htmlTitle guifg=#ffffff gui=none
...
" hi cssIdentifier guifg=#8fffff
hi cssIdentifier guifg=#729fcf
hi cssTagName guifg=#8fffff
